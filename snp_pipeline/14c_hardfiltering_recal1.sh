...
gatk VariantFiltration \
    -R ${REFERENCE}  \
    -V ${OUTDIR}/genotyped_samples_snps_recal1.vcf \
    --mask ${OUTDIR}/genotyped_samples_indels_recal1.vcf \
    --mask-extension 5 \
    --mask-name InDel \
    -O ${OUTDIR}/genotyped_samples_snps_filtered_recal1.vcf \
...
gatk VariantFiltration \
     -R ${REFERENCE} \
     -V ${OUTDIR}/genotyped_samples_indels_recal1.vcf \
     -O ${OUTDIR}/genotyped_samples_indels_filtered_recal1.vcf \
...
gatk SelectVariants \
    ...
    -V $OUTDIR/genotyped_samples_snps_filtered_recal1.vcf \
    -O $OUTDIR/bqsr_snps_recal1.vcf

gatk SelectVariants \
    --exclude-filtered true \
    -V $OUTDIR/genotyped_samples_indels_filtered_recal1.vcf \
